...
function CustomDrawer({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.sectionTitle}>FLUXO DE VENDA</Text>
      ...
      {etapas.map((etapa, index) => {
        ...
        return (
          ...
          >
            <View style={[styles.circle, ativa && styles.circleActive]}>
              <Text style={styles.circleText}>{index + 1}</Text>
            </View>
            <Text style={[styles.itemText, !liberada && styles.itemDisabled]}>
              {etapa}
            </Text>
          </TouchableOpacity>
        );
      ...
      <TouchableOpacity style={styles.cadastro}>
        ...
        <Text style={styles.cadastroText}>Cadastros</Text>
      </TouchableOpacity>
...
// --- Menu Lateral (Drawer) que engloba o Fluxo de Vendas ---
function MainDrawerNavigator() {
  return (
    <Drawer.Navigator
      ...
      screenOptions={{
        headerShown: true,
        headerStyle: { backgroundColor: '#3C40B8' },
        headerTintColor: '#FFF',
    ...
    >
      <Drawer.Screen
        ...
        options={({ route }) => {
          const routeName = getFocusedRouteNameFromRoute(route) ?? 'CarrinhoHome';
          return {
      ...
      <Drawer.Screen
        ...
        options={{
          headerRight: () => (
            <Text style={{ color: '#FFF', marginRight: 15 }}>Etapa 4 de 4</Text>
          ),
        }}
      />
    </Drawer.Navigator>
